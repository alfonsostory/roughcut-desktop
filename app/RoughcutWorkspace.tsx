        ...
        <div className="viewer-column">
          ...
          <div className="timeline-card">
            ...
            <div className="timeline-status">
              ...
              <span><i className="status-check">✓</i> Sentence onsets use audio + {Math.round(config.speechOnsetPadding * 1000)} ms pre-roll</span>
          ...
          <details className="settings-card">
            ...
            <div className="settings-grid">
              ...
              <label>Sentence-onset pre-roll <strong>{Math.round(config.speechOnsetPadding * 1000)} ms</strong><input type="range" min="0.1" max="0.2" step="0.01" value={config.speechOnsetPadding} onChange={(event) => updateConfig("speechOnsetPadding", Number(event.target.value))} /></label>
            </div>
          </details>
